...
<html>
    ...
    <body>
        ...
        background-color: #000;
            ...
            position: relative;">-->
        <div class="wrapper style3 mywrapper" style="background-image: url('${imageBackground}');">
            <div class="inner">
                ...
                <div class="box myshadow">
                    <div class="content">
                        ...
                        <div class="embed-responsive embed-responsive-21by9">
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/${detail.video}?autoplay=1&mute=1" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                        </div>
                        <br><br><br>
                        <p>${detail.content}</p>
